...
# 📘 Visual Example — traverse()
#
# Purpose:
# Visit every node in forward direction starting from head and process/print values.
#
# Cases covered:
# - empty list
# - single-node list
...
# Case: Traverse on Empty List
# ----------------------------
# Before:
# None
#
# traverse() -> prints nothing (or indicates empty)
#
# _______________________________________________________________________________________________________________________

# Case: Traverse on Single-Node List
# ----------------------------------
# Before:
# [10]
#  ↑head & tail
...
# Case: Traverse on Multi-Node List
# ---------------------------------
# Before:
# [10] ◀——▶ [20] ◀——▶ [30] ◀——▶ [40]
#  ↑head                          ↑tail
...
# → prints 30
# → prints 40
# (stop when current becomes head again)
#
# Complexity:
# - Time: O(n)
# - Space: O(1)
